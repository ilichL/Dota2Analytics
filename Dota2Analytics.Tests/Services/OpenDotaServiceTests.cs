...
public class OpenDotaAPIServiceTests
{
    ...
    private readonly Mock<IHeroRepository> _heroRepositoryMock;
    ...
    public async Task UpdatePlayerEmptySteamAccount()
    {
        ...
        var openDotaApiService = new OpenDotaAPIService(httpClient, heroRepository.Object, matchRepository.Object,
            _playerRepository.Object, _loggerMock.Object);
